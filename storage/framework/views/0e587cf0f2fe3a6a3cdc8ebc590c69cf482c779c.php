...
<form class="card p-3 bg-light" method="post" action="<?php echo e(route('hoadon_store')); ?>">
        ...
        <div class="col-md-6">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <label><input type="checkbox" name="idlop[]" value="<?php echo e($row->id); ?>"><?php echo e($row->tenlop); ?></label>        
...
<input class="form-control" required="true" type="text" name="noidung" value="" id="nd" onblur="myFunctionND()">
        ...
        <select class="form-control" required="true" name="loaigiay">
                ...
                <option value="<?php echo e($giay->id); ?>" name="loaigiay" id="loaigiay"><?php echo e($giay->loaigiay); ?></option>
...
<?php echo $__env->make('hoadon.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\photo\resources\views//hoadon/hoadon_create.blade.php ENDPATH**/ ?>