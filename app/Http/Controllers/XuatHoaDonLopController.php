...
///////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////// xuat theo khoi
public function exportkhoi(Request $request) {

        //$xuatkhoi = $request->input('xuatkhoi');    
        $tungay = $request->input('tungay');
        $denngay = $request->input('denngay');
...
///////////////////////////// sheet 10A2
		...
		$spreadsheet->createSheet();//Tao sheet moi
		$spreadsheet->setActiveSheetIndex($s);
		$sheet = $spreadsheet->getActiveSheet();
		$spreadsheet->getActiveSheet()->setTitle($lop->tenlop);
...
// Định dạng trang
        ...
        $sheet->setCellValue('C1','BẢNG KÊ TIỀN PHOTOCOPY LỚP: ');
		//foreach($hoadons as $hoadon){
        	$sheet->setCellValue('H1', $lop->tenlop);
			$sheet->setCellValue('D2', $lop->gvcn);	        
        	$sheet->setCellValue('I2', $lop->noptien);   //tiền NỘP
		//} 
...
////////////////////////////
	...
	if($hoadons->isNotEmpty()){
		foreach($hoadons as $hoadon){
		//$fileName = "XuatHoaDonAll-".$xuatkhoi.".xlsx";
		$fileName = "XuatHoaDonAll.xlsx";			
		$writer = new Xlsx($spreadsheet);
		$writer->save($fileName);
		}
    }
